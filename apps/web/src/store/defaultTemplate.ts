...
export const SAMPLE_LOGO_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 40"><rect width="160" height="40" rx="6" fill="%232563eb"/><circle cx="20" cy="20" r="10" fill="white"/><text x="38" y="25" fill="white" font-family="sans-serif" font-size="14" font-weight="bold">UNIVERSE</text></svg>`;

export const DEFAULT_A4_TEMPLATE: TemplateAst = {
  schemaVersion: '1.0.0',
  metadata: {
